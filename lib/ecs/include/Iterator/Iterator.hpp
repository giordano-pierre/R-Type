...
class ZipperIterator
{
    ...
    using iterator_t = decltype(std::begin(std::declval<Container &>())); // type of Container::begin() return value
    ...
    private:
        // Increment every iterator at the same time. It also skips to the next value if
        //      one of the pointed to std:: optional does not contains a value or according to
        //      the predicate function if specified.
