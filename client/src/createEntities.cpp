...
namespace Rtype::Client
{
  ...
  void createConfigGeneralEntites(ECS &ecs)
  {
    ...
    ecs.add_component<Rtype::Client::Hitbox>(interactP,
                                             {{float(1) / 4, float(1) / 15}});
    ecs.add_component<Rtype::Client::Text>(interactP, {"Interact",
                                                    myWindow._font,
                                                    {1, 1},
                                                    -0.1,
                                                    30,
    ...
    ecs.add_component<Rtype::Client::Hitbox>(colorP,
                                             {{float(1) / 4, float(1) / 15}});
    ecs.add_component<Rtype::Client::Text>(colorP, {"Colorblind mode",
                                                    myWindow._font,
                                                    {1, 1},
                                                    -0.1,
                                                    30,
    ...
    ecs.add_component<Rtype::Client::Hitbox>(languageP,
                                             {{float(1) / 4, float(1) / 15}});
    ecs.add_component<Rtype::Client::Text>(languageP, {"Language",
                                                    myWindow._font,
                                                    {1, 1},
                                                    -0.1,
                                                    30,
    ...
    ecs.add_component<Rtype::Client::Position>(
        resP,
        {float(serverSize.x) / 8 * float(4.3), float(serverSize.y) / 15 * float(11.8)});
    ecs.add_component<Rtype::Client::Tag>(resP, {CGENERAL});
    ecs.add_component<Rtype::Client::Hitbox>(resP,
                                             {{float(1) / 4, float(1) / 15}});
    ecs.add_component<Rtype::Client::Text>(resP, {"Window resolution",
                                                    myWindow._font,
                                                    {1, 1},
                                                    -0.1,
                                                    30,
    ...
    ecs.add_component<Rtype::Client::Hitbox>(interactB,
                                             {{float(1) / 10, float(1) / 10}});
    ecs.add_component<Rtype::Client::Text>(
        interactB, {getInput(myWindow._inputConfig.first, ENTER),
                  myWindow._font,
                  {1, 1},
                  0,
                  30,
    ...
    ecs.add_component<Rtype::Client::Position>(
        res1B,
        {float(serverSize.x) / 8 * float(7.3), float(serverSize.y) / 15 * float(11.8)});
    ...
    ecs.add_component<Rtype::Client::Hitbox>(res2B,
                                             {{float(1) / 10, float(1) / 10}});
    ecs.add_component<Rtype::Client::Text>(res2B, {"1440 x 810",
                                                   myWindow._font,
                                                   {1, 1},
                                                   0,
                                                   20,
    ...
    ecs.add_component<Rtype::Client::Hitbox>(res3B,
                                             {{float(1) / 10, float(1) / 10}});
    ecs.add_component<Rtype::Client::Text>(res3B, {"960 x 540",
                                                   myWindow._font,
                                                   {1, 1},
                                                   0,
                                                   20,
    ...
    ecs.add_component<Rtype::Client::Position>(
        lang1B,
        {float(serverSize.x) / 8 * float(7.3), float(serverSize.y) / 15 * float(9.7)});
    ecs.add_component<Rtype::Client::Tag>(lang1B, {CGENERAL});
    ecs.add_component<Rtype::Client::Hitbox>(lang1B,
                                             {{float(1) / 10, float(1) / 10}});
    ecs.add_component<Rtype::Client::Text>(lang1B, {"FR",
                                                   myWindow._font,
                                                   {1, 1},
                                                   0,
                                                   20,
    ...
    ecs.add_component<Rtype::Client::Hitbox>(lang2B,
                                             {{float(1) / 10, float(1) / 10}});
    ecs.add_component<Rtype::Client::Text>(lang2B, {"EN",
                                                   myWindow._font,
                                                   {1, 1},
                                                   0,
                                                   20,
