...
int mainTestGame(void) {
  ...
  ecs.add_component<Rtype::Client::Drawable>(
      back1, {myWindow[0].value()._myTextures.getTexture(
  ...
  ecs.add_component<Rtype::Client::Drawable>(
      back2, {myWindow[0].value()._myTextures.getTexture(
                  "assets/images/background/background_mountain.jpg"),
              {675, 360},
              {675, 360},
              1});
  ...
  ecs.add_component<Rtype::Client::Position>(
      entity1, {float(100), serverSize.y / float(2)});
  ...
  ecs.add_component<Rtype::Client::Drawable>(
      entity1, {myWindow[0].value()._myTextures.getTexture(
  ...
  ecs.subscribe<Rtype::Client::TicEvent, Rtype::Client::Position,
                Rtype::Client::Velocity>(moveSys);
  ecs.subscribe<Rtype::Client::InputEvent, Rtype::Client::Playable,
                Rtype::Client::Velocity>(moveSys);
  ...
  ecs.subscribe<Rtype::Client::TicEvent, Rtype::Client::Window,
                Rtype::Client::Type, Rtype::Client::Hitbox,
                Rtype::Client::Position>(borderSys);

  auto shootSys = Rtype::Client::ShootSys();
  ecs.subscribe<Rtype::Client::InputEvent, Rtype::Client::Window,
                Rtype::Client::Playable, Rtype::Client::Position,
                Rtype::Client::Hitbox>(shootSys);
...
int main(void) {
  ...
  ecs.add_component<Rtype::Client::Position>(
      button, {float(serverSize.x) / 2, float(serverSize.y) / 5});
  ecs.add_component<Rtype::Client::Type>(button, {Rtype::Client::BUTTON});
  ecs.add_component<Rtype::Client::Hitbox>(button, {{0.2, 0.07}});
  ecs.add_component<Rtype::Client::Text>(button, {"START",
                                                  myWindow[0].value()._font,
                                                  {0.5, 0.5},
                                                  {0.5, 0.5},
                                                  sf::Color::White});
  ecs.add_component<Rtype::Client::Drawable>(
      button, {myWindow[0].value()._myTextures.getTexture(
                   "assets/images/utils/Btn_V03.png"),
               {366, 67},
               {366, 67},
               1});
  ecs.add_component<Rtype::Client::Selectable>(
      button, {myWindow[0].value()._myTextures.getTexture(
                   "assets/images/utils/Btn_V03.png"),
               [](ECS ecs) { std::cout << "Start the game !" << std::endl; }});

  Entity button2 = ecs.spawn_entity();
  ecs.add_component<Rtype::Client::Position>(
      button2, {float(serverSize.x) / 2, float(serverSize.y) / 5 * 2});
  ecs.add_component<Rtype::Client::Type>(button2, {Rtype::Client::BUTTON});
  ecs.add_component<Rtype::Client::Hitbox>(button2, {{0.2, 0.07}});
  ecs.add_component<Rtype::Client::Text>(button2, {"CUSTOM",
                                                   myWindow[0].value()._font,
                                                   {0.5, 0.5},
                                                   {0.5, 0.5},
                                                   sf::Color::White,
  ...
  ecs.add_component<Rtype::Client::Drawable>(
      button2, {myWindow[0].value()._myTextures.getTexture(
                    "assets/images/utils/Btn_V03.png"),
                {366, 67},
                {366, 67},
                1});
  ecs.add_component<Rtype::Client::Selectable>(
      button2,
      {myWindow[0].value()._myTextures.getTexture(
           "assets/images/utils/Btn_V03.png"),
       [](ECS ecs) { std::cout << "Custom your ship !" << std::endl; }});

  Entity button3 = ecs.spawn_entity();
  ecs.add_component<Rtype::Client::Position>(
      button3, {float(serverSize.x) / 2, float(serverSize.y) / 5 * 3});
  ecs.add_component<Rtype::Client::Type>(button3, {Rtype::Client::BUTTON});
  ecs.add_component<Rtype::Client::Hitbox>(button3, {{0.2, 0.07}});
  ecs.add_component<Rtype::Client::Text>(button3, {"CONFIGS",
                                                   myWindow[0].value()._font,
                                                   {0.5, 0.5},
                                                   {0.5, 0.5},
                                                   sf::Color::White,
                                                   sf::Text::Style::Regular});
  ecs.add_component<Rtype::Client::Drawable>(
      button3, {myWindow[0].value()._myTextures.getTexture(
                    "assets/images/utils/Btn_V03.png"),
                {366, 67},
                {366, 67},
                1});
  ...
  ecs.add_component<Rtype::Client::Text>(button4, {"QUIT",
                                                   ...
                                                   sf::Text::Style::Regular});
  ecs.add_component<Rtype::Client::Drawable>(
      button4, {myWindow[0].value()._myTextures.getTexture(
                    "assets/images/utils/Btn_V03.png"),
                {366, 67},
                {366, 67},
                1});
  ecs.add_component<Rtype::Client::Selectable>(
      button4, {myWindow[0].value()._myTextures.getTexture(
                ...
                [](ECS &ecs) {
                  ...
                  ecs.post<Rtype::Client::InputEvent>(
                      {sf::Event(), Rtype::Client::QUIT});
                }});

  // Entity button5 = ecs.spawn_entity();
  // ecs.add_component<Rtype::Client::Position>(button5, {float(serverSize.x) /
  // 4 * 2, float(serverSize.y) / 3 * 2});
  // ecs.add_component<Rtype::Client::Type>(button5, {Rtype::Client::BUTTON});
  // ecs.add_component<Rtype::Client::Hitbox>(button5, {{0.2, 0.07}});
  // ecs.add_component<Rtype::Client::Text>(button5, {"Test 5",
  // myWindow[0].value()._font, {0.5, 0.5}, {0.5, 0.5},sf::Color::White,
  // sf::Text::Style::Regular});
  // ecs.add_component<Rtype::Client::Drawable>(button5,
  // {myWindow[0].value()._myTextures.getTexture("assets/images/utils/Btn_V03.png"),
  // {366, 67}, {366, 67}, 1});
  // ecs.add_component<Rtype::Client::Selectable>(button5,
  // {myWindow[0].value()._myTextures.getTexture("assets/images/utils/Btn_V03.png"),
  // [](ECS ecs){std::cout << "Button 5 is clicked!" << std::endl;}});

  // Entity button6 = ecs.spawn_entity();
  // ecs.add_component<Rtype::Client::Position>(button6, {float(serverSize.x) /
  // 4 * 3, float(serverSize.y) / 3 * 2});
  // ecs.add_component<Rtype::Client::Type>(button6, {Rtype::Client::BUTTON});
  // ecs.add_component<Rtype::Client::Hitbox>(button6, {{0.2, 0.07}});
  // ecs.add_component<Rtype::Client::Text>(button6, {"Test 6",
  // myWindow[0].value()._font, {0.5, 0.5}, {0.75, 0.5}, sf::Color::White,
  // sf::Text::Style::Regular});
  // ecs.add_component<Rtype::Client::Drawable>(button6,
  // {myWindow[0].value()._myTextures.getTexture("assets/images/utils/Btn_V03.png"),
  // {366, 67}, {366, 67}, 1});
  // ecs.add_component<Rtype::Client::Selectable>(button6,
  // {myWindow[0].value()._myTextures.getTexture("assets/images/utils/Btn_V03.png"),
  // [](ECS ecs){std::cout << "Button 6 is clicked!" << std::endl;}});
  ...
  ecs.subscribe<Rtype::Client::InputEvent, Rtype::Client::Position,
                Rtype::Client::Hitbox, Rtype::Client::Selectable>(pressSys);
